...
public class Frame1 {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.frame.setTitle("ENGINEERING EDUCATORS");
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frame = new JFrame();
		frame.setLayout(new GridLayout(0,1,0,3));
		...
		JInternalFrame internalFrame = new JInternalFrame("Test Question");
		...
		//specify the folder(Questions) containing all subfolders named Q1,Q2,Q3 
		File dir = new File("/Users/mitalibhiwande/Desktop/Questions/");
		...
		ImageIcon img1 = new ImageIcon(file.getAbsolutePath()+"/FBD.jpeg");
		ImageIcon img2 = new ImageIcon(file.getAbsolutePath() +"/Bridge.jpg");
		
		JInternalFrame internalFrame_1 = new JInternalFrame("Test Question");
