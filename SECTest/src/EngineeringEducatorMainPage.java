...
public class EngineeringEducatorMainPage {
	/**
	...
	static EngineeringEducatorQuestion questObject;
	static EngineeringEducatorQuestionsHandler qHandleObject  = new EngineeringEducatorQuestionsHandler(folderPath);
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					questionPath = qHandleObject.selectQuestion();
					questObject = new EngineeringEducatorQuestion(questionPath);
					UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName()); // Set Look and Feel of the UI
					EngineeringEducatorMainPage window = new EngineeringEducatorMainPage();
	 ...
	 * @param path
	 */
	public EngineeringEducatorMainPage() {
		initialize();
	}
	...
	private void initialize() {
		...
		endButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				EngineeringEducatorEndPage.main(arguments);
			}
		});
	...
	public void GUISettingAssumptionsList() {
		...
		//System.out.println("size    "+ EngineeringEducatorAssumption.assumptions.size());
	...
	public void GUISettingReasonsList(String assumption) {
		...
		EngineeringEducatorAssumption assumObject = questObject.getAssumObj(assumption);
