...
public class SecWindow {
	...
	static QuestionHandler qHandleObject  = new QuestionHandler(folderPath);
		...
		submitButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (isSubmitted) {
					...
					score = questObject.ScoreCalculation(score, reasonObject);
	...
	public void GUISettingReasonsList(String assumption) {
		...
		TestAssumption assumObject = questObject.getAssumObj(assumption);
		...
		assumObject.setRdbListVisibility(true);
	}
}
